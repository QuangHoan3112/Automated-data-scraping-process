...
# Nhập nickname của người dùng từ input
nickname = input("Nhập nickname của người dùng: ")

# Nhập số lượng truy vấn từ input
max_cursor = input("Nhập số lượng truy vấn: ")

# URL API
url = f"https://tiktok-scrapper-videos-music-challenges-downloader.p.rapidapi.com/user/{nickname}/feed"
...
if response.status_code == 200:
    ...
    output_file = f"tiktok_{nickname}_feed.json"
