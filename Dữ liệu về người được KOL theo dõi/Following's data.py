...
# URL API
url = f"https://tiktok-scrapper-videos-music-challenges-downloader.p.rapidapi.com/user/id/{user_id}/followings"
...
if response.status_code == 200:
    ...
    output_file = f"tiktok_user_{user_id}_followings.json"
