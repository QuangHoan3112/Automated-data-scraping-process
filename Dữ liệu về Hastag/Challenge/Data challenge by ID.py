...
# Nhập ID của challenge từ người dùng
challenge_id = input("Nhập id challenge cần tìm: ")

# URL API
url = f"https://tiktok-scrapper-videos-music-challenges-downloader.p.rapidapi.com/challenge/id/{challenge_id}"
...
if response.status_code == 200:
    ...
    output_file = f"tiktok_challenge_{challenge_id}.json"
