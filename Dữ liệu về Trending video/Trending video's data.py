...
# Nhập khu vực từ người dùng
region = input("Nhập khu vực cần tìm: ")

# URL API
url = f"https://tiktok-scrapper-videos-music-challenges-downloader.p.rapidapi.com/trending/{region}"
...
if response.status_code == 200:
    ...
    output_file = f"tiktok_trending_{region}.json"
